...
export const premiumModalSubmitButtonClassName =
  "h-12 rounded-[1.1rem] !bg-emerald-700 px-5 text-white !shadow-none transition-[background-color,color,box-shadow,transform] duration-200 hover:!bg-emerald-800 hover:!shadow-none active:scale-[0.96] active:!bg-emerald-900 active:!shadow-none focus-visible:!shadow-none";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {footer ? (
          <div className={cn(
            "relative z-10 w-full shrink-0 border-t border-slate-300/20 bg-white/95 px-[1.3rem] py-[1.1rem] backdrop-blur-md dark:border-slate-700/80 dark:bg-slate-900/95",
            footerClassName,
          )}>
            {footer}
          </div>
