...
import {
  ...
  SubmissionTypePill,
} from "@/components/dashboard/walas/walas-submissions-modals";
...
const WalasPengajuanReportModal = dynamic(
  () => import("@/components/reports/walas/walas-pengajuan-report-modal").then((module) => module.WalasPengajuanReportModal),
  { ssr: false },
);
