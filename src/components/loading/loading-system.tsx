...
export function DashboardRouteSkeleton({
  ...
  return (
    <div
      ...
      data-slot="loading-shell"
      className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(126,182,155,0.22),transparent_26%),radial-gradient(circle_at_top_right,rgba(111,166,208,0.12),transparent_18%),linear-gradient(180deg,#f7f5ee_0%,#f2f0e8_100%)] dark:bg-slate-950"
    >
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              {Array.from({ length: 4 }).map((_, index) => (
                <Skeleton key={index} className="h-20 rounded-[1.35rem] sm:h-24" />
              ))}
            </div>
          </div>
        </SkeletonPanel>
...
export function ChartSkeleton({ type = "line" }: { type?: "line" | "donut" }) {
  return (
    <section
      ...
      className="min-h-[280px] rounded-[2rem] border border-white/80 bg-white/78 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.07)] dark:border-slate-800 dark:bg-slate-900 dark:shadow-none"
    >
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-[calc(100vh-2.5rem)] w-full max-w-[640px] items-center">
        <div className="w-full rounded-[2.2rem] border border-white/80 bg-white/72 p-6 shadow-[0_28px_90px_rgba(22,85,58,0.12)] dark:border-slate-800 dark:bg-slate-900 dark:shadow-none sm:p-8">
          <div className="flex items-start justify-between gap-4">
          ...
          <div className="mt-8 rounded-[1.7rem] border border-emerald-100 bg-white/72 p-5 dark:border-emerald-900/70 dark:bg-slate-950/60">
