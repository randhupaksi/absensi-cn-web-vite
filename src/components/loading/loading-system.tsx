...
type PageSkeletonVariant =
  "dashboard" | "management" | "student-dashboard" | "profile" | "history";
...
export function BrandedAppLoader({
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,rgba(167,243,208,0.36),transparent_34%),linear-gradient(180deg,#f8fbf8_0%,#eef7f1_100%)] p-6"
    >
...
export function DashboardRouteSkeleton({
  ...
  return (
    <div
      ...
      className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(126,182,155,0.22),transparent_26%),radial-gradient(circle_at_top_right,rgba(111,166,208,0.12),transparent_18%),linear-gradient(180deg,#f7f5ee_0%,#f2f0e8_100%)]"
    >
      ...
      <main className="space-y-5 p-4 md:p-5 lg:pl-[292px]">
        <SkeletonTopbar />
    ...
    <div className="space-y-5">
      <div className="grid items-start gap-5 xl:grid-cols-[1.35fr_0.75fr]">
        ...
        <SkeletonPanel className="min-h-[270px]">
          ...
          <div className="mx-auto mt-7 size-32 rounded-full border-[18px] border-slate-200/70" />
    ...
    <div className="space-y-5">
      <SkeletonPanel>
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="min-h-[330px] rounded-[1.6rem] bg-emerald-800/90 p-6">
            ...
            <Skeleton className="mt-16 h-16 w-52 rounded-full bg-white/24" />
          </div>
          <div className="grid gap-4">
            <Skeleton className="h-40 rounded-[1.5rem]" />
            <div className="grid grid-cols-2 gap-4">
              {Array.from({ length: 4 }).map((_, index) => (
                <Skeleton key={index} className="h-24 rounded-[1.35rem]" />
              ))}
            </div>
          </div>
        </div>
  ...
  return (
    <SkeletonPanel>
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="min-h-[410px] rounded-[1.7rem] bg-emerald-800/90 p-7">
        ...
        <div className="rounded-[1.7rem] border border-slate-200/70 bg-white/70 p-6">
...
export function HistoryPageSkeleton() {
  return (
    <div className="space-y-5">
      ...
      <SkeletonPanel>
        <div className="flex flex-col gap-3 border-b border-slate-200/70 pb-5 sm:flex-row sm:justify-between">
...
export function TableSkeleton({
  ...
  const content = (
    <div className="min-w-[680px]">
      <div
        className="grid gap-4 bg-emerald-50/80 px-5 py-4"
      ...
      <div className="divide-y divide-emerald-50 bg-white/80">
  ...
  if (embedded)
    return (
      <div className="overflow-x-auto rounded-[1.35rem] border border-emerald-100">
        {content}
      </div>
    );
  return (
    <div className="overflow-x-auto rounded-[1.5rem] border border-emerald-100/80 shadow-[0_18px_42px_rgba(15,23,42,0.05)]">
      {content}
    </div>
  );
}
...
export function ModalContentSkeleton({ fields = 5 }: { fields?: number }) {
  return (
    <div role="status" aria-label="Memuat detail" className="space-y-5">
      <div className="rounded-[1.35rem] border border-emerald-100 bg-emerald-50/40 p-4">
  ...
  return (
    <div role="status" aria-label="Memuat daftar" className="space-y-3">
      {Array.from({ length: rows }).map((_, index) => (
        <div
          key={index}
          className="flex items-center gap-3 rounded-[1.25rem] border border-slate-100 bg-slate-50/75 p-3.5"
        >
...
export function ChartSkeleton({ type = "line" }: { type?: "line" | "donut" }) {
  return (
    <section
      ...
      className="min-h-[280px] rounded-[2rem] border border-white/80 bg-white/78 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.07)]"
    >
...
function SkeletonTopbar() {
  return (
    <div className="flex min-h-[104px] items-center justify-between gap-5 rounded-[2rem] border border-white/75 bg-white/72 px-5 py-4 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
...
function SkeletonPanel({
  ...
  return (
    <section
      className={cn(
        "rounded-[2rem] border border-white/82 bg-white/78 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.07)]",
        className,
      )}
    >
      {children}
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-4 xl:grid-cols-4">
      {Array.from({ length: 4 }).map((_, index) => (
        <div
          key={index}
          className="rounded-[1.5rem] border border-white/80 bg-white/72 p-4"
        >
    ...
    <SkeletonPanel>
      ...
      <div className="mt-5 space-y-3">
        {Array.from({ length: 4 }).map((_, index) => (
          <div
            key={index}
            className="flex items-center gap-3 rounded-[1.2rem] border border-slate-100 p-3"
          >
...
function LoginRouteSkeleton({ portal }: { portal: "student" | "staff" }) {
  ...
  return (
    <div
      ...
      className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(167,243,208,0.3),transparent_32%),linear-gradient(135deg,#f8fbf8_0%,#edf8f1_100%)] p-5"
    >
      <div className="mx-auto grid min-h-[calc(100vh-2.5rem)] max-w-[1480px] items-center gap-10 lg:grid-cols-[1fr_0.95fr]">
        ...
        <div className="mx-auto w-full max-w-[680px] rounded-[2.2rem] border border-white/80 bg-white/72 p-6 shadow-[0_28px_90px_rgba(22,85,58,0.12)] sm:p-8">
          ...
          <div className="mt-7 rounded-[1.7rem] border border-emerald-100 bg-white/72 p-5">
