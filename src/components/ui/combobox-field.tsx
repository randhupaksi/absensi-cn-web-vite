  ...
  return (
    ...
    >
      ...
      <PopoverContent
        ...
        sideOffset={8}
        className={cn(
          "w-[var(--anchor-width)] max-w-none overflow-hidden rounded-[1.4rem] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(243,252,247,0.98)_100%)] p-2 shadow-[0_24px_80px_rgba(15,23,42,0.18)] duration-0 data-open:animate-none data-closed:animate-none dark:border-slate-600 dark:bg-none dark:bg-slate-900 dark:shadow-[0_24px_80px_rgba(0,0,0,0.42)]",
          contentClassName,
        )}
      >
        <Command
