...
const routePreloaders: Record<string, RoutePreloader> = {
  ...
  "/dashboard/teacher/bk/attendance": () =>
    import("@/pages/bk/attendance-page"),
  "/dashboard/teacher/bk/counseling": () =>
    import("@/pages/bk/counseling-page"),
  "/dashboard/teacher/bk/students": () => import("@/pages/bk/students-page"),
  "/dashboard/teacher/bk/submissions": () =>
    import("@/pages/bk/submissions-page"),
  "/dashboard/teacher/homeroom/attendance": () =>
    import("@/pages/teacher/homeroom/attendance-page"),
  "/dashboard/teacher/homeroom/students": () =>
    import("@/pages/teacher/homeroom/students-page"),
  "/dashboard/teacher/homeroom/submissions": () =>
    import("@/pages/teacher/homeroom/submissions-page"),
  "/dashboard/teacher/subject/history": () =>
    import("@/pages/teacher/subject/history-page"),
  "/dashboard/teacher/subject/recap": () =>
