...
export function StaffShell({
  ...
  return (
    <div className="min-h-[100svh] bg-[radial-gradient(circle_at_top_left,rgba(126,182,155,0.22),transparent_26%),radial-gradient(circle_at_top_right,rgba(111,166,208,0.12),transparent_18%),linear-gradient(180deg,#f7f5ee_0%,#f2f0e8_100%)] text-slate-800 supports-[min-height:100dvh]:min-h-[100dvh]">
      <div className="min-h-[100svh] lg:pl-[272px] supports-[min-height:100dvh]:min-h-[100dvh]">
        <StaffSidebar
