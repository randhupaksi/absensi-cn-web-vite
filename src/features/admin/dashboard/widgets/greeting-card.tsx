          ...
          <div className="flex flex-wrap gap-2">
            {badges.map((item) => {
              ...
              return (
                <span
                  key={item.label}
                  className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-white/75 px-3.5 py-2 text-xs font-medium text-slate-600 shadow-sm dark:border-emerald-800 dark:bg-slate-800 dark:text-slate-300 dark:shadow-none"
                >
