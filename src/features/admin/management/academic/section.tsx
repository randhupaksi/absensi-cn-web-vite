import { ActionButtons, AddButton, DataTable, DataTableBody, DataTableCard, DataTableCell, DataTableHeadRow, DataTableRow, SectionTabSwitch, StatCard, StatusBadge, usePagination } from "@/features/admin/management/shared/section-ui";
