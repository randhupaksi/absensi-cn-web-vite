...
} from "@/features/admin/management/students/attendance-modals";
import {
  StudentMembershipCreateModal,
  StudentMembershipEditModal,
  MembershipStatusBadge,
  formatDateTime,
} from "@/features/admin/management/students/membership-modals";
import {
                  ...
                  {pageRules.map((rule) => (
                    <MobileDataCard key={rule.id}>
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-2">
                        <div className="rounded-[16px] border border-emerald-100 bg-white/80 px-3 py-2 dark:border-slate-700 dark:bg-slate-800">
