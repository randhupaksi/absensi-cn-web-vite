...
const EMPTY_FORM: TeacherProfileFormValues = {
  name: "",
  username: "",
  password: "",
  gender: "MALE",
...
export function TeacherProfileCreateModal({
  ...
  const form = useForm<TeacherProfileFormValues>({
    resolver: zodResolver(createTeacherProfileSchema),
  ...
  return (
    <PremiumModal
      ...
      description="Buat akun dan profil guru dalam satu proses."
      icon={FilePenLine}
    >
...
export function TeacherProfileEditModal({
  ...
  const defaults: TeacherProfileFormValues = teacher
    ? {
        name: teacher.name,
    ...
    : EMPTY_FORM;
  const form = useForm<TeacherProfileFormValues>({
    resolver: zodResolver(editTeacherProfileSchema),
  ...
  return (
    <PremiumModal
      ...
      description="Perbarui akun dan profil guru dalam satu proses."
      icon={FilePenLine}
    >
      <form className="grid gap-5" onSubmit={form.handleSubmit(onSubmit)}>
        <div className="grid gap-4 md:grid-cols-2">
...
function TeacherSelectFields({
  control,
  errors,
}: {
  control: ReturnType<typeof useForm<TeacherProfileFormValues>>["control"];
  errors: ReturnType<
    typeof useForm<TeacherProfileFormValues>
  >["formState"]["errors"];
}) {
  return (
    <div className="grid gap-4 md:grid-cols-2">
